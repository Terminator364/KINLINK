...
class MobilePlanVaultStore(context: Context) {
    ...
    fun read(): StoredMobilePlan? {
        ...
        if (schema !in 1..MobilePlanStoragePolicy.SCHEMA_VERSION) return null
        ...
        val cycleStartRaw =
            if (schema >= 2) prefs.getLong(KEY_CYCLE_START_EPOCH_MS, NO_CYCLE_START)
            else NO_CYCLE_START
        ...
        val config = MobilePlanConfig(
            ...
            cycleStartAtEpochMillis =
                cycleStartRaw.takeUnless { it == NO_CYCLE_START }
        )
    ...
    fun write(
        ...
        return prefs.edit()
            ...
            .putLong(
                KEY_CYCLE_START_EPOCH_MS,
                config.cycleStartAtEpochMillis ?: NO_CYCLE_START
            )
            .putLong(
    ...
    companion object {
        ...
        private const val KEY_CYCLE_START_EPOCH_MS = "cycle_start_epoch_ms"
        ...
        private const val NO_CYCLE_START = Long.MIN_VALUE
    }
}
