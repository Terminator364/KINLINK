...
req(state["communication_protocol"]["version"]==7,"project_state communication protocol stale")
...
req(bool(state["full_spec"]["active_wave"]),"cold takeover active wave missing")
