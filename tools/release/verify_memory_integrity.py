...
req(watch.get("schema")=="kinlink.communication_watchdog_policy/3","watchdog policy schema")
...
req(watch.get("stale_work_threshold_minutes") is None,"watchdog must not time-close active work")
